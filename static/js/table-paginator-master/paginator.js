...
function paginator(config) {
    ...
    stat.innerHTML = `Strona ${page} z ${pages}, pokazująca ${(trs.length<page*rows_per_page||rows_per_page==0?trs.length:page*rows_per_page) - (((page-1)*rows_per_page)+1) + 1} zmarłych z <b>${trs.length}</b>`;
