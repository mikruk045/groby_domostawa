...
def WGS_json_from_db(columns, table, connection):
    get_geom = "ST_AsGeoJSON(ST_Transform(geometria, '+proj=tmerc +lat_0=0 +lon_0=19 +k=0.9993 +x_0=500000 +y_0=-5300000 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs', 3857)) as geom"
